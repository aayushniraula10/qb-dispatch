...
dispatchCodes = {
	...
	["sivildown"] =  {displayCode = '10-13A', description = "Civilian Down", radius = 0, recipientList = {'ambulance'}, blipSprite = 480, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset"},
	...
	["chopcar"] =  {displayCode = '10-50', description = "Chopped Car", radius = 0, recipientList = {'police'}, blipSprite = 326, blipColour = 84, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset"},
	["banktruck"] =  {displayCode = '10-10', description = "Bank Truck", radius = 0, recipientList = {'police'}, blipSprite = 326, blipColour = 84, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset"},
	...
	["911call"] =  {displayCode = '911', description = "911 Call", radius = 0, recipientList = {'police'}, blipSprite = 480, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset"},
	...
	["yazarkasa"] =  {displayCode = '10-90', description = "Store Robbery In Progress", radius = 0, recipientList = {'police'}, blipSprite = 52, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset"},
	...
	["casino"] =  {displayCode = '10-80', description = "Casino Robbery", radius = 0, recipientList = {'police'}, blipSprite = 499, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "robberysound"},
	...
	["Hunting"] =  {displayCode = '10-95', description = "Illegal Hunting In Progress", radius = 0, recipientList = {'police'}, blipSprite = 84, blipColour = 60, blipScale = 1.5, blipLength = 2, sound = "robberysound"},
	...
	["atmrob"] =  {displayCode = '10-90', description = "ATM Robbery In Progress", radius = 0, recipientList = {'police'}, blipSprite = 119, blipColour = 1, blipScale = 1.5, blipLength = 2, sound = "Lose_1st", sound2 = "GTAO_FM_Events_Soundset"},
}
